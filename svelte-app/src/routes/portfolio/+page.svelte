...
<div class="container">
    ...
    <div class="card">
        <div class="item" style="background-image: url('{base}/web-design.png');"  aria-label="Web design background">
            <div class="text">
                ...
                <button><a href="{base}/web design">See More</a></button>
            </div>
        </div>
        <div class="item" style="background-image: url('{base}/game-design.png');"  aria-label="Game design background">
            <div class="text">
                ...
                <button><a href="{base}/game design">See More</a></button>
            </div>
        </div>
        <div class="item" style="background-image: url('{base}/game-development (2).png');" aria-label="Game development background">
            <div class="text">
                ...
                <button><a href="{base}/game dev">See More</a></button>
            </div>
        </div>
        <div class="item" style="background-image: url('{base}/digital-art.png');" aria-label="Digital art background">
            <div class="text">
                ...
                <button><a href="{base}/digital art">See More</a></button>
            </div>
        </div>
        <div class="item" style="background-image: url('{base}/tattoo-design.png');"  aria-label="Tattoo design background">
            <div class="text">
                ...
                <button><a href="{base}/tattoo design">See More</a></button>
            </div>
        </div>
        <div class="item" style="background-image: url('{base}/paintings.png');"  aria-label="Paintings background">
            <div class="text">
                ...
                <button><a href="{base}/paintings">See More</a></button>
            </div>
        </div>
    </div>
